...
CPI <- read.csv("SeriesReport-20250919121805_45263d.csv") %>% select(Year, Annual)
## Pull CPI for 2024
...
rent <- read.csv("FY2025_FMR_50_county.csv") %>% #4764 obs
...
union_elections <- read.csv("all_elections_1.19_12.24.csv") %>%
...
ita <- read.csv("ITA 300A Summary Data 2024 through 04-30-2025.csv")
